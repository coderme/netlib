...
import (
	...
	"github.com/coderme/netlib/internal/binding"
)
...
const handwritten = `// Code generated by "go generate github.com/coderme/netlib/lapack/lapacke" from {{.Header}}; DO NOT EDIT.
